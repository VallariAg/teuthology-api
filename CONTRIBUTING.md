...
If you experience bugs or general issues with `teuthology-api`, please have a look
...
You can help improve `teuthology-api` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`teuthology-api` documentation uses [Sphinx] as its main documentation compiler.
...
5. Install [pre-commit]:
   ...
   `teuthology-api` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/ceph/teuthology-api
[issue tracker]: https://github.com/ceph/teuthology-api/issues
